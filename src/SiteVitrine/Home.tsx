...
function Home() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      {/* Conteneur principal avec carousel */}
      <div className="relative flex-1 flex flex-col items-center justify-center text-center px-4 py-11 overflow-hidden">
      ...
      {/* Footer fixé au bas */}
      <footer className="w-full bg-black text-white  py-2 px-4">
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row justify-between items-center gap-4">
          {/* Copyright */}
          <div className="text-sm text-white/80">
            © {new Date().getFullYear()} Bridman Groupe. Tous droits réservés.
          </div>
          
          {/* Icône Facebook avec lien */}
          <a
            href="https://www.facebook.com/profile.php?id=61586093703424"
            target="_blank"
          ...
          >
            <svg 
              className="w-6 h-6 text-white hover:scale-110 transition-transform duration-300"
              fill="currentColor" 
              viewBox="0 0 24 24"
